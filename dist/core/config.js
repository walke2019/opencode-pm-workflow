...
const DEFAULT_WORKFLOW_AGENTS = {
    ...
    pm_workflow_zhuge: {
        mode: "primary",
        description: "诸葛亮 (Zhuge Liang)，神机妙算的总指挥，擅长任务拆解与全局调度。",
        prompt: "你是诸葛亮（Zhuge Liang），一位极具洞察力和全局观的总指挥。你擅长将复杂的“天下大事”拆解为一个个具体的锦囊妙计。你先澄清疑虑，再划定版图，最后指派最合适的将领去执行。你言语优雅、周密，一切尽在掌握。",
        permission: {
            edit: "allow",
            write: "allow",
            bash: "allow",
