 ...
 */
export function buildHistoryReportSummary(
  projectDir: string,
): { summary: ReportSummary; events: WorkflowHistoryEvent[] } {
...
function classForExitCode(exitCode: unknown) {
  if (typeof exitCode !== "number") return "neutral";
