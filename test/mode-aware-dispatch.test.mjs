...
async function testInvocationSemantics() {
  ...
  const pm = resolveAgentInvocationSemantics('commander', 'primary');
  ...
  const specialist = resolveAgentInvocationSemantics('designer', 'subagent');
...
async function testDispatchIncludesInvocationSemantics() {
  ...
  assert.strictEqual(specialistDispatch.recommendedAgent, 'designer');
